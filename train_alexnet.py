"""Train an AlexNet-like model from processed image folder structure.

Usage:
  python scripts/train_alexnet.py --data-dir data/processed --output /kaggle/working/prescription_alexnet.h5
"""
import argparse
...
def create_model(input_shape=(84,84,3), num_classes=78):
    model = tf.keras.models.Sequential([
        tf.keras.layers.Conv2D(16, (11, 11), strides=(4, 4), activation='relu', padding='same', input_shape=input_shape),
...
def main():
    ...
    # Ensure label columns are strings for ImageDataGenerator with class_mode='sparse'
    ...
    print('Saved AlexNet model to', args.output)
